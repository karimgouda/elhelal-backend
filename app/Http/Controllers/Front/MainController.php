...
class MainController extends Controller
{
    ...
    public function home()
    {
        ...
        $about = Leader::first();
        $services = ServicesMenu::limit(6)->get();
        $projects = Worker::get();
        $teams = AboutSlider::get();
        return view('web.frontend.pages.home', compact('about', 'features', 'characteristics','services','projects','teams'));
    }
